 ...
 *
 * � uma classe de servi�os, como Math e outras de Java, pelo que devem ser
 * usados os m�todos de classe implementados.
 *
 * Utiliz�vel em BlueJ, NetBeans, CodeBlocks ou Eclipse.
 * 
 * Utiliza��o t�pica:  int x = Input.lerInt();
